...
export const WorkshopSubmitPage = () => {
    ...
    const [errors, setErrors] = useState({figure: "", artwork: "", artist: ""})
    ...
    const handleSubmit = event => {
        console.log('infro', figure, artwork, artist,background)
        event.preventDefault();
    ...
    const onSubmit = async () => {
        ...
        try {
            ...
            await contract.methods.createFigure(figure, JSON.stringify({title: artwork, name: artist, image: 'https://tse1-mm.cn.bing.net/th/id/OIP.fq3C-Dodg9sC0xlCNuB4IQHaLH?w=204&h=306&c=7&o=5&pid=1.7', description: background? background: ''}))
                .send({from: account})
