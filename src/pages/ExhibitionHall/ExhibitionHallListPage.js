...
export const ExhibitionHallListPage = () => {
    ...
    async function fetch(){
      fetchList().then(({tokens, hashtags}) => setList({tokens,hashtags}))
    }
    ...
    var tokens = tag == null ? list.tokens : list.tokens.filter(t => 
      t.hashtags.indexOf(tag) != -1
    )
        ...
        <article className="exhibition-hall center">
            ...
            <div className="hashtag">
                ...
                >
                    ...
                    {!showMoreHashtags
                        ? list.hashtags.slice(0, 7).map(hashtag => (
